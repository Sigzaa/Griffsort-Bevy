...
impl Plugin for Viewer{
    fn build(&self, app: &mut App){
        ...
        app
            ...
            .add_system(update_lights.run_in_state(GameState::Viewer))
            .add_system(camera_controller.run_in_state(GameState::Viewer))
            .add_system(start_animation.run_in_state(GameState::Viewer))
            .add_system(keyboard_animation_control.run_in_state(GameState::Viewer))
            .add_system(keyboard_cameras_control.run_in_state(GameState::Viewer))
            .run();
    }
}
