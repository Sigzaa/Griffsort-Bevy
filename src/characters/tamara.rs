...
impl Plugin for Tamara {
    fn build(&self, app: &mut App) {
        app.add_system_set(SystemSet::on_update(GameState::InGame).with_system(Tamara::sync_rotation::<Tamara>))
...
fn load_textures(mut rpg_sprite_handles: ResMut<ExplSpriteHandles>, asset_server: Res<AssetServer>) {
                ...
                match collision_event{
                    CollisionEvent::Started(ent1, ent2, _flag) => {
                        if ent == *ent1 || ent == *ent2{
                             ...
                             let texture_handle = asset_server.load("sprites/pack1/PNG/Explosion/Explosion6.png");
